...
//		printf("Server Version: MsgServer/%s\n", VERSION);
	...
	uint32_t d_push_server_count = 0;
	serv_info_t* d_push_server_list = read_server_config(&config_file, "DPushServerIP",
                                                       "DPushServerPort", d_push_server_count);
    
	uint32_t s_push_server_count = 0;
	serv_info_t* s_push_server_list = read_server_config(&config_file, "SPushServerIP",
                                                       "SPushServerPort", s_push_server_count);
	...
	init_d_push_serv_conn(d_push_server_list, d_push_server_count);
	init_s_push_serv_conn(s_push_server_list, s_push_server_count);
