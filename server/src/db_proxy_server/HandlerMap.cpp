...
void CHandlerMap::Init()
{
    ...
    // message content
    m_handler_map.insert(make_pair(uint32_t(CID_MSG_GET_DAYS_REQ), DB_PROXY::getMessageDays));
    m_handler_map.insert(make_pair(uint32_t(CID_MSG_GET_DURING_TIME_REQ), DB_PROXY::getMessageDuringTime));
