...
public:
    ...
    void getMessageDays(uint32_t nUserId, uint32_t nPeerId, list<string>& lsDay);
    void getMessageDuringTime(uint32_t nUserId, uint32_t nPeerId, uint32_t nStartTime,
